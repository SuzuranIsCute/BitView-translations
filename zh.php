...
$LANGS['vpnbrowser'] = "您不能使用 VPN 注册新账号！";
$LANGS['torbrowser'] = "您不能使用 TOR 注册新账号！";
$LANGS['captchaincorrect'] = "You didn't type in the code correctly.";
$LANGS['toomanyaccounts'] = '您所持有的账号过多！';
$LANGS['banned2times'] = "您被封禁的次数已达到了两次，因此您无法再注册新账号！";
$LANGS['nohistory'] = "您目前无任何最近观看的视频呢～";
$LANGS['historycleared'] = '您的历史记录已成功清除！';
$LANGS['watchdisabled'] = '出于维护目的，此视频不能观看！';
$LANGS['videonotexist'] = '此视频不存在，或由于此视频违反了我们的使用条款导致其被移除。';
$LANGS['responseerror'] = 'Something went wrong with your video response! Please check URL again.';
$LANGS['responseexist'] = '您的视频已被接受！';
$LANGS['responseadded'] = 'Video response added successfully!';
$LANGS['responseaccepted'] = 'Accepted new Video Response!';
$LANGS['60secscomment'] = '请在1分钟后，才可发布新评论！';
...
$LANGS['videoalreadyinpl'] = '视频已成功添加至播放列表中！';
...
$LANGS['nocriteria'] = "您的账号不符合要求标准！";
$LANGS['alreadypartner'] = '你已成功批准加入我们的合作伙伴计划！';
$LANGS['alreadyapplied'] = '你已成功加入！';
$LANGS['applicationsent'] = 'Your application has been submitted!';
$LANGS['joinedgroup'] = '您已成功加入此群组！';
$LANGS['leftgroup'] = '您已成功退出此群组！';
$LANGS['grouprequest'] = '群组邀请已成功发送！现在您只需等待就可以啦！';
...
$LANGS['3groups'] = '您不能拥有超过 3 个群组！';
$LANGS['groupnameempty'] = '群组名称不能为空白！';
$LANGS['groupdescempty'] = '群组介绍不能为空白！';
$LANGS['groupnoimage'] = '您必须为您的群主上传图片！';
$LANGS['groupimageerror'] = '群组图片Group images must be under 1MB and be an image file!';
$LANGS['groupcreated'] = 'Group has succesfully been created!';
$LANGS['urlnotvalid'] = "此URL无效！";
...
$LANGS['flagnote'] = "注意！请确认此视频是因为违反了我们的规则而举报。Don't report just because you don't like that video, otherwise you'll be be hindering moderators' job.";
...
$LANGS['about4'] = '安全并私密地向您的家人和您来自世界各地的好友展示您的视频';
$LANGS['about5'] = '...和其他用途！';
...
$LANGS['enforceguidelines'] = "总之，这些就是我们的准则";
